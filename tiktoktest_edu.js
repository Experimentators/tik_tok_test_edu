...
flowScheduler.add(qesedu1RoutineBegin());
flowScheduler.add(qesedu1RoutineEachFrame());
flowScheduler.add(qesedu1RoutineEnd());
flowScheduler.add(ansedu1RoutineBegin());
flowScheduler.add(ansedu1RoutineEachFrame());
flowScheduler.add(ansedu1RoutineEnd());
flowScheduler.add(qesedu2RoutineBegin());
flowScheduler.add(qesedu2RoutineEachFrame());
flowScheduler.add(qesedu2RoutineEnd());
flowScheduler.add(ansedu2RoutineBegin());
flowScheduler.add(ansedu2RoutineEachFrame());
flowScheduler.add(ansedu2RoutineEnd());
flowScheduler.add(qesedu3RoutineBegin());
flowScheduler.add(qesedu3RoutineEachFrame());
flowScheduler.add(qesedu3RoutineEnd());
flowScheduler.add(ansedu3RoutineBegin());
flowScheduler.add(ansedu3RoutineEachFrame());
flowScheduler.add(ansedu3RoutineEnd());
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'videorandom_edu.xlsx', 'path': 'videorandom_edu.xlsx'},
    {'name': 'videos1.MP4', 'path': 'videos1.MP4'},
    {'name': 'videos2.MP4', 'path': 'videos2.MP4'},
    {'name': 'videos3.MP4', 'path': 'videos3.MP4'},
    {'name': 'videos4.MP4', 'path': 'videos4.MP4'},
    {'name': 'videos5.MP4', 'path': 'videos5.MP4'},
    {'name': 'videos6.MP4', 'path': 'videos6.MP4'},
    {'name': 'videos7.MP4', 'path': 'videos7.MP4'},
    {'name': 'videos8.MP4', 'path': 'videos8.MP4'},
    {'name': 'videos9.MP4', 'path': 'videos9.MP4'},
    {'name': 'conditions.xlsx', 'path': 'conditions.xlsx'},
  ]
});
...
async function experimentInit() {
  ...
  vidosikClock = new util.Clock();
  vidosik = new visual.MovieStim({
    win: psychoJS.window,
    movie: null,
    name: 'vidosik',
  ...
  // Initialize components for Routine "qesedu1"
  qesedu1Clock = new util.Clock();
  text_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_4',
    text: 'Где было запрещено носить одежду фиолетового цвета?\nнажмите пробел после ввода ответа\n',
    font: 'Arial',
    units: undefined, 
  ...
  // Initialize components for Routine "ansedu1"
  ansedu1Clock = new util.Clock();
  ansver_1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'ansver_1',
    text: 'правильно: римская империя',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], draggable: false, height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  // Initialize components for Routine "qesedu2"
  qesedu2Clock = new util.Clock();
  ...
  text_6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_6',
    text: 'Как называется мельчайшая частица материи?\nнажмите пробел после ввода ответа\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.2], draggable: false, height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  // Initialize components for Routine "ansedu2"
  ansedu2Clock = new util.Clock();
  ansver_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'ansver_2',
    text: 'правильно: кварк',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], draggable: false, height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  // Initialize components for Routine "qesedu3"
  qesedu3Clock = new util.Clock();
  text_7 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_7',
    text: 'Тихий и Атлантический океаны не смешиваются из-за разницы в _\nнажмите пробел после ввода ответа\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0.2], draggable: false, height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
  ...
  // Initialize components for Routine "ansedu3"
  ansedu3Clock = new util.Clock();
  ansver_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'ansver_3',
    text: 'правильно: солености',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], draggable: false, height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
...
function cpt1_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of cpt1_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function randomizationLoopBegin(randomizationLoopScheduler, snapshot) {
  return async function() {
    ...
    randomization = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.RANDOM,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'videorandom_edu.xlsx',
    ...
    // Schedule all the trials in the trialList:
    for (const thisRandomization of randomization) {
...
function cpt1_routineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of cpt1_routineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_cpt1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of end_cpt1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function videosetRoutineBegin(snapshot) {
    return async function () {
      ...
      // keep track of which components have finished
      videosetComponents = [];
      videosetComponents.push(vidosik);
      videosetComponents.push(key_resp_5);
      
      for (const thisComponent of videosetComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function videosetRoutineEachFrame() {
    return async function () {
      ...
      // *vidosik* updates
      if (t >= 0.0 && vidosik.status === PsychoJS.Status.NOT_STARTED) {
        // keep track of start time/frame for later
        vidosik.tStart = t;  // (not accounting for frame time here)
        vidosik.frameNStart = frameN;  // exact frame index
        
        vidosik.setAutoDraw(true);
        vidosik.play();
      }
      
      if (vidosik.status === PsychoJS.Status.FINISHED) {  // force-end the Routine
          continueRoutine = false;
      }
...
function videosetRoutineEnd(snapshot) {
    return async function () {
      ...
      vidosik.stop();  // ensure movie has stopped at end of Routine
      // update the trial handler
      if (currentLoop instanceof MultiStairHandler) {
...
var qesedu1MaxDurationReached;
var _key_resp_8_allKeys;
var qesedu1MaxDuration;
var qesedu1Components;
function qesedu1RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'qesedu1' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      ...
      qesedu1Clock.reset();
      routineTimer.reset();
      qesedu1MaxDurationReached = false;
      // update component parameters for each repeat
      textbox_q1.setText('');
      textbox_q1.refresh();
      ...
      _key_resp_8_allKeys = [];
      psychoJS.experiment.addData('qesedu1.started', globalClock.getTime());
      qesedu1MaxDuration = null
      // keep track of which components have finished
      qesedu1Components = [];
      qesedu1Components.push(text_4);
      qesedu1Components.push(textbox_q1);
      qesedu1Components.push(key_resp_8);
      
      for (const thisComponent of qesedu1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function qesedu1RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'qesedu1' ---
      // get current time
      t = qesedu1Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function qesedu1RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'qesedu1' ---
      for (const thisComponent of qesedu1Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('qesedu1.stopped', globalClock.getTime());
      ...
      key_resp_8.stop();
      // the Routine "qesedu1" was not non-slip safe, so reset the non-slip timer
      routineTimer.reset();
...
var ansedu1MaxDurationReached;
var ansedu1MaxDuration;
var ansedu1Components;
function ansedu1RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'ansedu1' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      routineForceEnded = false;
      ansedu1Clock.reset(routineTimer.getTime());
      routineTimer.add(1.000000);
      ansedu1MaxDurationReached = false;
      // update component parameters for each repeat
      psychoJS.experiment.addData('ansedu1.started', globalClock.getTime());
      ansedu1MaxDuration = null
      // keep track of which components have finished
      ansedu1Components = [];
      ansedu1Components.push(ansver_1);
      
      for (const thisComponent of ansedu1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ansedu1RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'ansedu1' ---
      // get current time
      t = ansedu1Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function ansedu1RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'ansedu1' ---
      for (const thisComponent of ansedu1Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('ansedu1.stopped', globalClock.getTime());
      if (routineForceEnded) {
          routineTimer.reset();} else if (ansedu1MaxDurationReached) {
          ansedu1Clock.add(ansedu1MaxDuration);
      } else {
          ansedu1Clock.add(1.000000);
      }
      // Routines running outside a loop should always advance the datafile row
      if (currentLoop === psychoJS.experiment) {
        psychoJS.experiment.nextEntry(snapshot);
...
var qesedu2MaxDurationReached;
var _key_resp_4_allKeys;
var qesedu2MaxDuration;
var qesedu2Components;
function qesedu2RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'qesedu2' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      ...
      qesedu2Clock.reset();
      routineTimer.reset();
      qesedu2MaxDurationReached = false;
      // update component parameters for each repeat
      textbox_q2.setText('');
      textbox_q2.refresh();
      ...
      _key_resp_4_allKeys = [];
      psychoJS.experiment.addData('qesedu2.started', globalClock.getTime());
      qesedu2MaxDuration = null
      // keep track of which components have finished
      qesedu2Components = [];
      qesedu2Components.push(textbox_q2);
      qesedu2Components.push(text_6);
      qesedu2Components.push(key_resp_4);
      
      for (const thisComponent of qesedu2Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function qesedu2RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'qesedu2' ---
      // get current time
      t = qesedu2Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function qesedu2RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'qesedu2' ---
      for (const thisComponent of qesedu2Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('qesedu2.stopped', globalClock.getTime());
      ...
      key_resp_4.stop();
      // the Routine "qesedu2" was not non-slip safe, so reset the non-slip timer
      routineTimer.reset();
...
var ansedu2MaxDurationReached;
var ansedu2MaxDuration;
var ansedu2Components;
function ansedu2RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'ansedu2' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      routineForceEnded = false;
      ansedu2Clock.reset(routineTimer.getTime());
      routineTimer.add(1.000000);
      ansedu2MaxDurationReached = false;
      // update component parameters for each repeat
      psychoJS.experiment.addData('ansedu2.started', globalClock.getTime());
      ansedu2MaxDuration = null
      // keep track of which components have finished
      ansedu2Components = [];
      ansedu2Components.push(ansver_2);
      
      for (const thisComponent of ansedu2Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ansedu2RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'ansedu2' ---
      // get current time
      t = ansedu2Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function ansedu2RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'ansedu2' ---
      for (const thisComponent of ansedu2Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('ansedu2.stopped', globalClock.getTime());
      if (routineForceEnded) {
          routineTimer.reset();} else if (ansedu2MaxDurationReached) {
          ansedu2Clock.add(ansedu2MaxDuration);
      } else {
          ansedu2Clock.add(1.000000);
      }
      // Routines running outside a loop should always advance the datafile row
      if (currentLoop === psychoJS.experiment) {
        psychoJS.experiment.nextEntry(snapshot);
...
var qesedu3MaxDurationReached;
var _key_resp_9_allKeys;
var qesedu3MaxDuration;
var qesedu3Components;
function qesedu3RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'qesedu3' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      ...
      qesedu3Clock.reset();
      routineTimer.reset();
      qesedu3MaxDurationReached = false;
      // update component parameters for each repeat
      textbox_q3.setText('');
      textbox_q3.refresh();
      ...
      _key_resp_9_allKeys = [];
      psychoJS.experiment.addData('qesedu3.started', globalClock.getTime());
      qesedu3MaxDuration = null
      // keep track of which components have finished
      qesedu3Components = [];
      qesedu3Components.push(text_7);
      qesedu3Components.push(textbox_q3);
      qesedu3Components.push(key_resp_9);
      
      for (const thisComponent of qesedu3Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function qesedu3RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'qesedu3' ---
      // get current time
      t = qesedu3Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function qesedu3RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'qesedu3' ---
      for (const thisComponent of qesedu3Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('qesedu3.stopped', globalClock.getTime());
      ...
      key_resp_9.stop();
      // the Routine "qesedu3" was not non-slip safe, so reset the non-slip timer
      routineTimer.reset();
...
var ansedu3MaxDurationReached;
var ansedu3MaxDuration;
var ansedu3Components;
function ansedu3RoutineBegin(snapshot) {
    return async function () {
      TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
      
      //--- Prepare to start Routine 'ansedu3' ---
      t = 0;
      frameN = -1;
      continueRoutine = true; // until we're told otherwise
      // keep track of whether this Routine was forcibly ended
      routineForceEnded = false;
      ansedu3Clock.reset(routineTimer.getTime());
      routineTimer.add(1.000000);
      ansedu3MaxDurationReached = false;
      // update component parameters for each repeat
      psychoJS.experiment.addData('ansedu3.started', globalClock.getTime());
      ansedu3MaxDuration = null
      // keep track of which components have finished
      ansedu3Components = [];
      ansedu3Components.push(ansver_3);
      
      for (const thisComponent of ansedu3Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ansedu3RoutineEachFrame() {
    return async function () {
      //--- Loop for each frame of Routine 'ansedu3' ---
      // get current time
      t = ansedu3Clock.getTime();
      frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
      // update/draw components on each frame
...
function ansedu3RoutineEnd(snapshot) {
    return async function () {
      //--- Ending Routine 'ansedu3' ---
      for (const thisComponent of ansedu3Components) {
        if (typeof thisComponent.setAutoDraw === 'function') {
          thisComponent.setAutoDraw(false);
        }
      }
      psychoJS.experiment.addData('ansedu3.stopped', globalClock.getTime());
      if (routineForceEnded) {
          routineTimer.reset();} else if (ansedu3MaxDurationReached) {
          ansedu3Clock.add(ansedu3MaxDuration);
      } else {
          ansedu3Clock.add(1.000000);
      }
      // Routines running outside a loop should always advance the datafile row
      if (currentLoop === psychoJS.experiment) {
        psychoJS.experiment.nextEntry(snapshot);
...
function cpt2_instRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of cpt2_instComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function cpt2_routineRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of cpt2_routineComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function end_cpt2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of end_cpt2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
